            ...
            <div class="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
              <div class="lg:pl-20">
                <div class="max-w-xs px-2.5 lg:max-w-none">
                  <img
                    ...
                    decoding="async"
                    class="aspect-square rotate-3 rounded-2xl bg-zinc-100 object-cover text-transparent dark:bg-zinc-800"
                    loading="lazy"
                    width="800"
                    height="800"
                  />
              ...
              <div class="lg:pl-20">
                <ul role="list flex">
                  <li class="flex">
                    <a
                      class="group flex text-sm font-medium text-zinc-800 transition hover:text-primary-500 dark:text-zinc-200 dark:hover:text-primary-500"
                  ...
                  <li class="mt-8 flex border-t border-zinc-100 pt-8 dark:border-zinc-700/40">
                    ...
                    >
                      ...
                      <span class="ml-4">ilija.radivojevic237@gmail.com</span>
                    </a>
                  </li>
                </ul>
              </div>
